...
cor.test(x = data_rp$moff_intensity, y = data_rp$maxquant_intensity, method = 'pearson')
"FlashLFQ versus MaxQuant"
cor.test(x = data_rp$flash_intensity, y = data_rp$maxquant_intensity, method = 'pearson')
"FlashLFQ versus moFF"
cor.test(x = data_rp$flash_intensity, y = data_rp$moff_intensity, method = 'pearson')
```
