...
```{r}
write.table(unique(mq$peptide), file="mq_peptides.tab",
            sep="\t", quote=FALSE, row.names=FALSE)
write.table(unique(moff$peptide), file="moff_peptides.tab",
            sep="\t", quote=FALSE, row.names=FALSE)
write.table(unique(flash$Sequence), file="flash_peptides.tab",
            sep="\t", quote=FALSE, row.names=FALSE)
```
