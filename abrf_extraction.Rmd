...
### With match-between-runs (with MBR)
```{r}
maxquant <- read.delim("2019_datasets/ABRF/MaxQuant_GUI/with_MBR/peptides.txt", stringsAsFactors = FALSE)
...
```{r}
merge(flash %>% select(Sequence, flash_sample1 = Intensity_ABRF_2016_40Y_1_Sample1),
